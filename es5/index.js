...
(function () {
	...
	var Box2D = __webpack_require__(18);
...
(function () {
	...
	var _require = __webpack_require__(17),
	    Physics = _require.Physics,
	    Body = _require.Body,
	    b2Vec2 = _require.b2Vec2;

	var FMath = __webpack_require__(25);
	...
	var Level = function () {
		...
		_createClass(Level, [{
			...
			value: function addHero() {
				...
				var bodyProperties = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
				var HeroClass = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : Hero;
				...
				for (var y = 0; y < this.height; y++) {
					for (var x = 0; x < this.width; x++) {
						...
						if (this.stops[offset]) {
							new Body(this.physics, { type: 'static', x: x, y: y, width: 1, height: 1 });
						}
					}
				}
				// boundaries
	...
	var Hero = function () {
		function Hero(_ref2) {
			var _ref2$id = _ref2.id,
			    ...
			    maxSpeed = _ref2$maxSpeed === undefined ? 10 : _ref2$maxSpeed,
			    _ref2$jumpHeight = _ref2.jumpHeight,
			    jumpHeight = _ref2$jumpHeight === undefined ? 25 : _ref2$jumpHeight,
			    _ref2$jumpInterval = _ref2.jumpInterval,
			    jumpInterval = _ref2$jumpInterval === undefined ? 1000 : _ref2$jumpInterval,
		...
		_createClass(Hero, [{
			key: 'addBody',
			value: function addBody(physics) {
				var details = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
			...
			key: 'goto',
			value: function goto(_ref3) {
				var x = _ref3.x,
				    y = _ref3.y;

				var r = distance(x, y);
				if (r) {
					var d = this.maxSpeed / r;
					var newx = 0;
					var newy = 0;
					if (!this.gravity) {
